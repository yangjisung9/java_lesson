...
/*   자바인터페이스의 특징
 *   1. 객체를 직접 생성하지 않습니다.
 *   2. 필드는 상수만 있습니다.		상수필드이므로 public static final 생략합니다. 인스턴스 필드 없습니다.
 ...
 */
		...
		//추가적인 기능은 디폴트 메소드로 정의해서 사용합니다. (그냥 추가하면 하나씩 추상메소드 다 추가해줘야됨)
		default void methodD(String message) {	//디폴트(인스턴스와 유사) 메소드 : 재정의를 위해 만듭니다.
